...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/assets/marquee3k.js" type="text/javascript"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.25.0/moment.min.js" integrity="sha256-imB/oMaNA0YvIkDkF5mINRWpuFPEGVCEkHy6rm2lAzA=" crossorigin="anonymous"></script>
    <?php wp_head(); ?>
  </head>
  <body>
